...
export default function populateBlueprintStyleOptionsValue(isState = false) {
    const blueprintStyleSelectValue = isState ? global.id.stateBlueprintPropertySelect.value : global.id.blueprintPropertySelect.value;
    const blueprintStyleInput = isState ? global.id.blueprintStatePropertyInput : global.id.propertyBlueprintInput;
