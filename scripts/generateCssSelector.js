...
export default function generateCssSelector(
	...
	// This is being done somewhere else
    // // Handle head section
    // if (jsonObj.head) {
    ...
    //         fontElement.setAttribute('href', font);
    //         document.head.appendChild(fontElement);
    //     }
    // }

    // // Handle classroom section
    // if (jsonObj.classroom) {
    //     for (const classObj of jsonObj.classroom) {
    //         if (classObj.type === 'class') {
    //             cssMap.set(`.${classObj.name}`, classObj.style);
    //         } else if (classObj.type === 'element') {
    //             cssMap.set(classObj.name, classObj.style);
    //         }
    //     }
    // }
